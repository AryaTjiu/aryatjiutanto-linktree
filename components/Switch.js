...
export default function Switch () {
    ...
    return (
        <div className="absolute right-6 md:right-28 top-6 md:top-10 text-xl">
            <button className="w-12 h-12 grid place-content-center border border-[#181818] bg-transparent hover:bg-[#181818] dark:border-neutral-200 dark:hover:bg-neutral-200 rounded-lg group duration-200" onClick={() => setIsDark(!isDark)} onMouseEnter={() => setHovered("Change theme")} onMouseLeave={() => setHovered(false)}>
